...
$this->Validator::addRule('uniqueUsername', function ($field, $value, array $params) {
...
$this->Validator::addRule('uniqueEmail', function ($field, $value, array $params) {
// check if user is logged in
if($this->wire('user')->isLoggedin()){
...
* [0]: User object: The user object of the user who tries to login with Tfa enabled
...
/**
* 12) Check if the value enterd is different than another value entered as param
* $field->setRule('differentValue', 'test'); // entered value must be different than "test" to return true
*/
...
* $field->setRule('differentPassword', $user); // entered value must be different than "test" to return true
*/
